        ...
        <footer className="p-4 bg-white md:p-8 lg:p-10 dark:bg-gray-800">
            <div className="mx-auto max-w-screen-xl text-center">
                ...
                <div class="flex mt-4 space-x-6 justify-center sm:mt-0">
                    <a href="https://www.facebook.com/gyanarthimedia1/" class="text-gray-500 hover:text-gray-900 dark:hover:text-white" target='_blank'>
                    ...
                    <a href="https://www.instagram.com/gyanarthimediacollege_kashipur/" class="text-gray-500 hover:text-gray-900 dark:hover:text-white" target='_blank'>
